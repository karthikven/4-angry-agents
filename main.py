...
import argparse
from experiments import run_s0, run_s1, run_s2, run_s3 # Import the new s3 runner
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        # Add s1, s2, and s3 to the list of choices
        choices=["s0", "s1", "s2", "s3"], 
        help="The name of the experiment to run (e.g., 's0', 's1', 's2', 's3')."
    )
